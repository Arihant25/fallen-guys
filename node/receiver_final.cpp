...
void readThingSpeakThresholds()
{
    ...
    // // Fall Acceleration Threshold
    // int temp_fallAcc_threshold = ThingSpeak.readIntField(thresholdReadChannel, 1, myReadAPIKey);
    // response = ThingSpeak.getLastReadStatus();
    // if (response == 200) {
    //   fallAcc_threshold = temp_fallAcc_threshold;
    ...
    // int temp_alert_threshold = ThingSpeak.readIntField(thresholdReadChannel, 2, myReadAPIKey);
    // response = ThingSpeak.getLastReadStatus();
    // if (response == 200) {
    //   alert_threshold = temp_alert_threshold;
    ...
    // // Emergency Contact
    // int temp_emergencyContact = ThingSpeak.readIntField(thresholdReadChannel, 3, myReadAPIKey);
    // response = ThingSpeak.getLastReadStatus();
    // if (response == 200) {
    //   emergencyContact = temp_emergencyContact;
    ...
    // // Password
    // String temp_password = ThingSpeak.readStringField(thresholdReadChannel, 4, myReadAPIKey);
    // response = ThingSpeak.getLastReadStatus();
    // if (response == 200) {
